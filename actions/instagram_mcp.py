...
Instagram Model Context Protocol (MCP) & Background Social Engine for Ultron AI.
...
- Dual-mode: In-process service for Ultron + standalone MCP JSON-RPC server over stdio.
"""
