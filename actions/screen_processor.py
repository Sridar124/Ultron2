...
SYSTEM_PROMPT = (
    "You are Ultron AI, an open-source assistant. "
    ...
    "Be concise, smart, and helpful like Ultron AI, personal assistant to User. "
            ...
            async for response in self._session.receive():
                ...
                if sc.turn_complete:
                    if transcript_buf and self._player:
                        ...
                        if full:
                            self._player.write_log(f"Ultron AI: {full}")
    ...
    if angle != "camera":
        try:
            ...
            if w_info and w_info.get("title"):
                ...
                if w_title and "ultron" not in w_title.lower():
