...
"""
Smart Desktop & Downloads Organizer MCP for Ultron AI.
...
PROTECTED_FILENAMES = {
    ...
    "ultron_history.json", "organizer_history.json",
    "email_credentials.json", ".email_key", "api_keys.json"
}
PROTECTED_DIR_PREFIXES = (".", "ultronprojects", ".ultron", ".git", ".venv", "node_modules", "$recycle.bin")
