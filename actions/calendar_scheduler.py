...
"""
Calendar and Schedule Management for Ultron AI.
...
def calendar_scheduler(
    ...
    if action in ("add", "add_event", "create", "new"):
        ...
        ics_lines = [
            "BEGIN:VCALENDAR",
            "VERSION:2.0",
            "PRODID:-//Ultron AI//Calendar Scheduler//EN",
        ]
        for ev in events:
            try:
                ...
                ics_lines.extend([
                    "BEGIN:VEVENT",
                    f"UID:{ev.get('id', uuid.uuid4())}@ultron.ai",
        ...
        desktop_ics = Path.home() / "Desktop" / "ultron_calendar.ics"
...
def run(parameters: dict, player=None, session_memory=None) -> str:
    """Plugin wrapper for Ultron architecture."""
