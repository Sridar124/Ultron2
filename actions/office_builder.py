"""
office_builder.py - Ultron AI office document generation
...
DEFAULT_OUTPUT_DIR = Path.home() / "Desktop" / "UltronAI"
...
def _resolve_output_path(output_path: str | None, title: str, ext: str) -> Path:
    ...
    return DEFAULT_OUTPUT_DIR / f"{_sanitize_filename(title, 'ultron_ai_output')}{ext}"
