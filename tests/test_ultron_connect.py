...
from ultron_connect.gateway.command_router import CommandRouter
from ultron_connect.gateway.device_manager import DeviceManager
from ultron_connect.gateway.capability_manager import CapabilityManager
from ultron_connect.gateway.models import DeviceRecord
from ultron_connect.gateway.pairing import PairingManager
from ultron_connect.gateway.protocol import ProtocolTypes, build_message, validate_message
from ultron_connect.gateway.websocket import ConnectionHub
...
def test_pairing_manager_returns_expiring_offer():
    ...
    assert offer.service == "_ULTRON._tcp.local."
