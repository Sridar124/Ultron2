"""
core/audio_devices.py — pick which microphone and which speakers Ultron uses.
...
WHY
    ...
    "Ultron can't hear me" almost always means "Ultron is listening to the
...
WHY THIS IS CACHED
    ...
    milliseconds on a Windows machine with many endpoints. Ultron learned this
