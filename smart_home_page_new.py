...
class UltronHomePage(QWidget):
    def __init__(self, parent=None):
        ...
        self.setObjectName("UltronHomePageModern")
        self.setStyleSheet(f"QWidget#UltronHomePageModern {{ background: transparent; }} QScrollArea {{ background: transparent; border: none; }}")
    ...
    def _animate_voice(self):
        ...
        if hasattr(self, "_voice_cmd_lbl") and self._voice_cmd_lbl:
            self._voice_cmd_lbl.setText({"Idle": '"Ultron"', "Listening": '"Turn bedroom fan to speed 4"', "Thinking": '"Understanding..."', "Executing": '"Applying command..."', "Completed": '"Done"'}.get(self._voice_state, '"Ultron"'))
