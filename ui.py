...
from smart_home_page_new import UltronHomePage, _DeviceTile
...
LOGO_FILE  = BASE_DIR / "assets" / "Ultron_Logo.png"
LOGO_ICO   = BASE_DIR / "assets" / "Ultron_Logo.ico"
    ...
    def _do_set_ai_state(self, state: str) -> None:
        if self._web_view:
            try:
                ...
                if page:
                    page.runJavaScript(f"if(window.setUltronState) window.setUltronState('{st}');")
            except Exception:
                pass
...
class RemoteKeyOverlay(QWidget):
    ...
    def __init__(self, url: str, key: str, auto: str, manual: str, parent=None):
        ...
        subtitle = QLabel("Scan the QR code with your phone to remotely control Ultron.")
    ...
    def mark_connected(self) -> None:
        ...
        self._timer_lbl.setText("Phone connected. Ultron remote is ready.")
...
class DailyBriefingOverlay(QWidget):
    ...
    def __init__(self, data=None, parent=None):
        ...
        title_lbl = QLabel("⚡ ULTRON INTELLIGENCE // UNIFIED MORNING BRIEFING")
...
class MemoryInspectorOverlay(QWidget):
    ...
    def _rebuild(self):
        ...
        cap = QLabel(
            ...
            f"Ultron recalls these during relevant conversations."
        )
...
class TaskCard(QFrame):
    def __init__(self, parent=None):
        ...
        self._plan_lbl = QLabel("Plan: Ultron will generate a task plan after you send a command.")
    ...
    def set_task(self, title: str, desc: str, percent: int):
        ...
        self._plan_lbl.setText("Plan: Ultron will generate a task plan after you send a command.")
...
class ConversationFeed(QScrollArea):
    ...
    def _ensure_empty_widget(self):
        ...
        lay.setContentsMargins(14, 12, 14, 12)
        lay.setSpacing(10)
        title = QLabel("Try asking Ultron")
...
class WorkspaceSidebar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._title = QLabel("ULTRON WORKSPACE")
...
class InlineChatWorkspace(QFrame):
    ...
    def _build_chat_tab(self) -> QWidget:
        ...
        self._footer_status = QLabel("Ultron is ready")
...
class LauncherControlPanel(QDialog):
    def __init__(self, *, startup_workspace: bool = False, on_open=None, on_close=None,
        ...
        self._restart_btn = mk_btn("Restart Ultron")
        self._quit_btn = mk_btn("Quit Ultron")
...
class UltronTelemetryWing(QFrame):
    """
    Ultron Right Wing: Live Operations, Research Streams, and Sources.
    Auto-dismisses in 10 seconds unless pinned or hovered.
    Adapts dynamically to the active theme color (Amber Gold by default).
    """
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setObjectName("UltronTelemetryWing")
...
class UltronResultWing(QFrame):
    """
    Ultron Left Wing: Final Results, Generated Deliverables (PDF/Word/Media/Code),
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setObjectName("UltronResultWing")
        self.setFixedWidth(310)
        self.setMinimumHeight(320)
        ...
        if self._active_file_path:
            ...
            if p.exists():
                try:
                    ...
                    print(f"[UltronResultWing] Open file error: {e}")
    ...
    def _on_reveal_clicked(self):
        if self._active_file_path:
            ...
            try:
                ...
                print(f"[UltronResultWing] Reveal error: {e}")
...
class SetupOverlay(QWidget):
    ...
    def _build_stage3(self):
        ...
        self._intro_lines = []
        for txt in ["Identity confirmed.", "Hello.", "I'm Ultron.", "Ready whenever you are."]:
            lbl = QLabel(txt)
            lbl.setAlignment(Qt.AlignmentFlag.AlignCenter)
            if txt == "I'm Ultron.":
        ...
        self._launch_btn = QPushButton("Launch Ultron →")
...
class CommandBar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Input field
        self._input = QLineEdit()
        self._input.setPlaceholderText("Tell Ultron what to do...")
...
class DeveloperModeDialog(QDialog):
    def __init__(self, parent=None, settings: dict | None = None):
        ...
        desc = QLabel("Pick a workspace folder Ultron should use when building websites or other workspace-based tasks.")
...
class MeetingOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._answer = QLabel("Ultron will show the live answer here.")
...
class FloatingLauncher(QWidget):
    ...
    def _show_menu(self, global_pos):
        ...
        open_full = QAction("Open Ultron (Full App)", self)
        ...
        quit_act = QAction("Quit Ultron", self)
...
class MainWindow(QMainWindow):
    ...
    def _startup_enabled(self) -> bool:
        ...
        try:
            with winreg.OpenKey(
                ...
                try:
                    value, _ = winreg.QueryValueEx(key, "Ultron")
                    run_value = _startup_run_value()
                    if value != run_value:
                        winreg.SetValueEx(key, "Ultron", 0, winreg.REG_SZ, run_value)
                    return bool(value)
    ...
    def set_ultron_connect_service(self, service):
        self._ultron_connect = service
    ...
    def _browse_attachment(self):
        path, _ = QFileDialog.getOpenFileName(
            self, "Attach a file to Ultron", str(Path.home()),
            "All Files (*.*);;"
            "Images (*.jpg *.jpeg *.png *.gif *.webp *.bmp *.svg);;"
            "Documents (*.pdf *.docx *.txt *.md *.pptx);;"
            "Data (*.csv *.xlsx *.json *.xml);;"
        ...
        if hasattr(self, "_result_card") and low.startswith("you:"):
            ...
            if self.on_chat_event and user_msg:
                try:
                    ...
                    pass
        if hasattr(self, "_result_card") and low.startswith("ultron:"):
    ...
    def notify_phone_connected(self):
        ...
        self._log_sig.emit("SYS: Phone connected to Ultron remote.")
    ...
    def _apply_state(self, state: str):
        ...
        if hasattr(self, "_input"):
            ph_map = {
                ...
                "SPEAKING": "Ultron is responding...",
                "THINKING": "Ultron is thinking...",
            ...
            self._input.setPlaceholderText(ph_map.get(state, "Ask Ultron anything..."))
        ...
        if hasattr(self, "_inline_workspace") and hasattr(self._inline_workspace, "_footer_status"):
            ...
            self._inline_workspace._footer_status.setText(foot_map.get(state, "Ultron is online"))
        ...
        if hasattr(self, "_task_card"):
            if state in ("THINKING", "PROCESSING", "EXECUTING", "WORKING"):
                self._task_card.set_task("Working on it...", "Ultron is processing your request.", 72)
            elif state == "SPEAKING":
                self._task_card.set_task("Responding...", "Ultron is speaking now.", 100)
            elif state == "MUTED":
                self._task_card.set_task("Microphone muted", "Voice input is paused.", 0)
            else:
                self._task_card.set_task("Ready", "Ultron is idle and ready.", 0)
        if hasattr(self, "_result_card"):
            if state in ("THINKING", "PROCESSING", "EXECUTING", "WORKING"):
    ...
    def _on_setup_done(self, key: str, or_key: str, os_name: str):
        try:
            ...
            self.showNormal()
            self._apply_state("LISTENING")
            self._log.append_log(f"SYS: Initialised. OS={os_name.upper()}. Ultron online.")
        except Exception as e:
    ...
    def _build_center_panel_modern(self, face_path: str) -> QWidget:
        ...
        self._hud_result_wing = UltronResultWing(self)
        self._hud_telemetry_wing = UltronTelemetryWing(self)
        ...
        self._home_page = UltronHomePage()
        self._devices_page = UltronConnectDevicesPage(self)
    ...
    def _build_right_panel_modern(self) -> QWidget:
        ...
        header_title = QLabel("ULTRON CHAT")
    ...
    def _build_command_row(self) -> QHBoxLayout:
        ...
        self._input = QLineEdit()
        self._input.setPlaceholderText("Ask Ultron anything...")
        self._input.setFont(QFont("Segoe UI", 10))
...
class SystemConnectivitySidebar(QFrame):
    def __init__(self, controller=None, parent=None):
        ...
        self._mk_quick_action("Γå╗ Restart Ultron", QStyle.StandardPixmap.SP_BrowserReload, self._restart)
...
class SettingsHubPage(QWidget):
    def __init__(self, navigation_callback, parent=None):
        ...
        subtitle = QLabel("Select a section below to configure your Ultron environment.")
        ...
        cards_data = [
            ("Ultron Home", "Configure smart home integrations", "🏠", 1),
...
class SystemConnectivityPage(QWidget):
    ...
    def _build_left_column(self):
        ...
        # Instagram Connect
        ig_card = self._card("Instagram Connect", "Connect your personal Instagram account to allow Ultron to manage your DMs.")
        ...
        self._set_ast_name.textChanged.connect(lambda t: identity.set_assistant_name(t.strip() or "Ultron"))
        ...
        # Mobile connect
        mobile = self._card("Mobile Connect", "Connect your phone and control Ultron remotely.")
        ml = mobile.layout()
        ...
        # Startup
        startup = self._card("Startup", "Use Ultron with Windows startup preferences.")
        sl = startup.layout()
        self._startup_launch_btn = self._mk_toggle("Launch Ultron when Windows starts", bool(self._load_app_settings().get("show_workspace_on_startup", False)), self._toggle_startup_from_page)
        ...
        # Shortcuts & Pinning
        shortcuts = self._card("Shortcuts & Pinning", "Create shortcuts and pin Ultron to your Windows system.")
        ...
        # App Theme
        theme_card = self._card("App Theme", "Select the primary color theme for Ultron.")
        ...
        lay.addWidget(anim)
        # Discord bot
        discord = self._card("Discord Bot", "Mirror Ultron between the app and your server.")
        dl = discord.layout()
        ...
        about = self._card("About Ultron", "Ultron information only.")
        ab = about.layout()
        ...
        self._ah_rule_input.setPlaceholderText("Teach Ultron a rule (e.g. Always summarize in bullet points)")
    ...
    def _handle_ah_trigger_test_bug(self):
        try:
            ...
            self._ah_output_lbl.setText(
                ...
                f"Traceback captured in AutoHealEngine! Click 'Fix Captured Bug' or say 'Ultron, fix that bug'."
            )
    ...
    def _test_discord_from_page(self):
        ...
        if self._ctrl() and hasattr(self._ctrl(), "_win"):
            ...
            self._discord_msg.setText("Connected as Ultron#9649" if self._discord_token.text().strip() else "Bot Offline")
    ...
    def refresh(self):
        ...
        if enabled and token:
            ...
            self._discord_msg.setText("Connected as Ultron#9649")
        elif token:
...
class SmartDevicesSection(QFrame):
    def __init__(self, controller=None, parent=None):
        ...
        """)
        self._open_home_btn.clicked.connect(self._open_ultron_home)
        ...
        empty_btn = QPushButton("Open Ultron Home")
        ...
        """)
        empty_btn.clicked.connect(self._open_ultron_home)
...
class UltronConnectDevicesPage(QFrame):
    def __init__(self, parent=None):
        super().__init__(parent)
        self._service = None
        ...
        self.setObjectName("UltronConnectDevicesPage")
        self.setStyleSheet(f"""
            QFrame#UltronConnectDevicesPage {{
                background: transparent;
                border: none;
            }}
            QLabel {{
        ...
        self._subtitle = QLabel("Everything connected to Ultron.")
    ...
    def _service_obj(self):
        return self._service or getattr(self.parentWidget(), "_ultron_connect", None)
    ...
    def _refresh_onboarding_offer(self):
        ...
        try:
            ...
            self._onboarding_offer = dict(service.create_pairing_offer(device_name="Ultron Connect", platform="gateway"))
...
class UltronUI:
    ...
    def set_ultron_connect_service(self, service):
        self._win.set_ultron_connect_service(service)
    ...
    def show_content(self, title: str, body: str):
        """Universal rich content presenter. Automatically routes to the Ultron Holographic Left Deliverable Wing."""
        import re
        file_path = None
