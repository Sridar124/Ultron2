"""Check for and apply fast-forward updates from the Ultron GitHub repository."""
...
REMOTE = "https://github.com/titechprabhasolutions/Ultron---personal.git"
BRANCH = "main"
...
def update_from_github(base_dir: Path) -> bool:
    ...
    if os.environ.get("ULTRON_SKIP_UPDATE") == "1":
        return False
