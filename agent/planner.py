...
PLANNER_PROMPT = """You are the planning module of Ultron AI, a personal AI assistant.
...
auto_heal
  ...
  Use whenever user asks to fix an error/bug, heal/patch Ultron, undo/rollback a patch, view patch history, or remember a permanent rule/behavioral preference.
